...
void __fastcall TForm1::ScrollBar1Change(TObject *Sender)
{
   ...
   if(ComPort1->Connected )  {
      ...
      if(pwm>230)  Shape1->Brush->Color=clYellow;
      else
      if(pwm>180)  Shape1->Brush->Color=clMoneyGreen;
      else
      if(pwm>140)  Shape1->Brush->Color=clSilver;
      else
      if(pwm>100)  Shape1->Brush->Color=clMedGray;
      else
      if(pwm>60)  Shape1->Brush->Color=clGray;
      else
      if(pwm>30)  Shape1->Brush->Color=cl3DDkShadow;
      else
